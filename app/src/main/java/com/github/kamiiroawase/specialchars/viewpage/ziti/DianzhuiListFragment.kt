...
class DianzhuiListFragment : Fragment() {
    ...
    companion object {
        ...
        fun getFontList(text: String): List<ZitiFragment.FontItem> {
            return listOf(
                ZitiFragment.FontItem(customBuildString(text, "", "̚")),
                ZitiFragment.FontItem(customBuildString(text, "", "҈")),
                ZitiFragment.FontItem(customBuildString(text, "", "҉")),
                ZitiFragment.FontItem(customBuildString(text, "៚", "ོོ ͜✿ ҉҉҉҉҉")),
                ZitiFragment.FontItem(customBuildString(text, "ζั͡ ", "ζั͡✾")),
                ZitiFragment.FontItem(customBuildString(text, "ζั͡ ", "ζั͡✿")),
                ZitiFragment.FontItem(customBuildString(text, "ζั͡ ", "ζั͡❀")),
                ZitiFragment.FontItem(customBuildString(text, "", "ஊ")),
    ...
    private fun setUpFontList() {
        ...
        ZitiFragment.chineseListAdapter = adapter
    }
}