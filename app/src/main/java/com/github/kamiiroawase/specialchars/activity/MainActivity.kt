...
class MainActivity : BaseActivity() {
    ...
    private fun restoreFragments(savedInstanceState: Bundle) {
        currentItemId = savedInstanceState.getInt(CURRENT_ITEM_ID, R.id.navigationZiti)

        val zitiFragment =
            supportFragmentManager.findFragmentByTag(R.id.navigationZiti.toString()) as? ZitiFragment
                ?: ZitiFragment()
        val duanyuFragment =
            supportFragmentManager.findFragmentByTag(R.id.navigationDuanyu.toString()) as? DuanyuFragment
                ?: DuanyuFragment()
        val wodeFragment =
            supportFragmentManager.findFragmentByTag(R.id.navigationWode.toString()) as? WodeFragment
                ?: WodeFragment()
