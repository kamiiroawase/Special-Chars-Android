...
class ZitiliebiaoFragment : Fragment() {
    ...
    companion object {
        ...
        fun getFontList(text: String): List<ZitiFragment.FontItem2> {
            return listOf(
                ZitiFragment.FontItem2(text, Typeface.SANS_SERIF, "sans-serif"),
                ZitiFragment.FontItem2(text, Typeface.MONOSPACE, "monospace"),
                ZitiFragment.FontItem2(text, Typeface.SERIF, "serif")
            )
        }
    }
    ...
    private fun setUpFontList() {
        ...
        ZitiFragment.fontListAdapter = adapter
    }
}